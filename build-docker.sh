...
../login-docker.sh
docker tag guacamole-server-native:latest public.ecr.aws/v2s2h8i9/procyon-guacamole-server-native:cezary
docker push public.ecr.aws/v2s2h8i9/procyon-guacamole-server-native:cezary